...
const CourseDetail = () => {
  ...
  useEffect(() => {
    ...
    // setIsPurchased(purchasedCourses.includes(courseId));
    setIsPurchased(true);
  ...
  const updatedCoursesData:any = {
    ...coursesData,
    frontend: {
      ...coursesData.frontend,
      modules: coursesData.frontend.modules.map(module => ({
        ...module,
    ...
    backend: {
      ...coursesData.backend,
      modules: coursesData.backend.modules.map(module => ({
        ...module,
        sections: module.sections?.map(section => ({
          ...section,
        })) || []
    ...
    fullstack: {
      ...coursesData.fullstack,
      modules: coursesData.fullstack.modules.map(module => ({
        ...module,
        sections: module.sections?.map(section => ({
          ...section,
        })) || []
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="border rounded-lg p-5 bg-card shadow-sm">
                ...
                <BuyCourseButton 
                  ...
                  redirectUrl={`/course-detail/${courseId}`}
